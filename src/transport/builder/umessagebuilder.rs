...
use crate::transport::validator::UAttributesValidator;
use crate::uprotocol::{
    Data, UAttributes, UMessage, UMessageType, UPayload, UPayloadFormat, UPriority, UUri, UUID,
};
...
pub enum BuilderError {
    ...
    AttributesValidationError(crate::transport::validator::ValidationError),
}
...
impl From<crate::transport::validator::ValidationError> for BuilderError {
    fn from(value: crate::transport::validator::ValidationError) -> Self {
        Self::AttributesValidationError(value)
    }
}

impl From<protobuf::Error> for BuilderError {
...
impl<'a> Default for UMessageBuilder<'a> {
    fn default() -> Self {
        UMessageBuilder {
            validator: Box::new(crate::transport::validator::PublishValidator),
            comm_status: None,
...
impl<'a> UMessageBuilder<'a> {
    ...
    ///
    /// ```rust
    /// # use up_rust::uprotocol::SerializationError;
    /// use up_rust::uprotocol::{UMessageType, UPayloadFormat, UPriority, UUri};
    /// use up_rust::transport::builder::UMessageBuilder;
    ...
    pub fn request(
        ...
        UMessageBuilder {
            validator: Box::new(crate::transport::validator::RequestValidator),
    ...
    pub fn response(
        ...
        UMessageBuilder {
            validator: Box::new(crate::transport::validator::ResponseValidator),
    ...
    /// # use up_rust::uprotocol::SerializationError;
    /// use up_rust::uuid::builder::UUIDBuilder;
    /// use up_rust::uprotocol::{UCode, UMessageType, UPriority, UUri};
    /// use up_rust::transport::builder::UMessageBuilder;
    ///
    /// # fn main() -> Result<(), Box<dyn std::error::Error>> {
    /// let uuid_builder = UUIDBuilder::new();
    ...
    /// # Returns
    ///
    /// A message ready to be sent using [`crate::transport::datamodel::UTransport::send`].
    ///
    /// # Errors
    ///
    /// If the properties set on the builder do not represent a consistent set of [`UAttributes`],
    /// a [`BuilderError::AttributesValidationError`] is returned.
    ///
    /// # Examples
    ///
    /// ```rust
    ...
    /// # }
    /// ```
    pub fn build(&self, uuid_builder: &UUIDBuilder) -> Result<UMessage, BuilderError> {
    ...
    /// # Errors
    ///
    /// If the given payload cannot be serialized into a byte array, a [`BuilderError::DataSerializationError`] is returned.
    /// If the properties set on the builder do not represent a consistent set of [`UAttributes`],
    /// a [`BuilderError::AttributesValidationError`] is returned.
    ///
    /// # Examples
    ...
    /// # use up_rust::uprotocol::SerializationError;
    /// use up_rust::uprotocol::{UCode, UStatus, UUri};
    /// use up_rust::transport::builder::UMessageBuilder;
    /// use up_rust::uuid::builder::UUIDBuilder;
    ///
    /// # fn main() -> Result<(), Box<dyn std::error::Error>> {
