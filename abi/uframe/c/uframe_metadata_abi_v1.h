...
/* Payload encoding registry ids 1..=7 are assigned:
 *   1 protobuf-wrapped-in-any, 2 protobuf, 3 json, 4 someip, 5 someip-tlv,
 *   6 raw, 7 UTF-8 text. Zero is contract-defined, not absence.
 * Every 16-bit value is structurally representable; the four-byte slot is
 * retained. FIELD_PAYLOAD_ENCODING determines presence. Allocation policy
 * and decoder support are independent of frame structural validation. */
