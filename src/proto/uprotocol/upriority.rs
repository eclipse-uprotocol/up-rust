...
impl UPriority {
    ...
    ///
    /// ```
    /// use up_rust::uprotocol::UPriority;
    ///
    ...
    /// ```
    pub fn try_from_priority_code<T: Into<String>>(code: T) -> Result<Self, ParsingError> {
        ...
        Self::enum_descriptor()
            ...
            .ok_or_else(|| ParsingError::new(format!("unknown priority [{}]", prio)))
    }
}
