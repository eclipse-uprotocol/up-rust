...
// Semantic fields mirror the fixture protos; explicit byte-array padding makes
// every byte of the native representation initialized and describable.
#![expect(
    missing_docs,
...
pub struct CanClassicFrameV1 {
    ...
    pub can_id: u32,
    pub flags: u32,
    pub timestamp_padding: [u8; 4],
    pub bus_timestamp_ns: u64,
    pub len: u8,
    pub len8_dlc: u8,
    pub data: [u8; 8],
    pub checksum_padding: [u8; 2],
    pub checksum: u32,
}
